...
//			return false;
	...
	// this.cagesPermutationsMap.get(smallestValueCage)) {
	...
	// List<String> cellsInBoxi = cellsInBox(Integer.parseInt(rc[0]),
	...
	// if (this.matrix[Integer.parseInt(split[0])][Integer.parseInt(split[1])] !=
	// UNASSIGNED) {
	// alreadyFilledValue =
	// this.matrix[Integer.parseInt(split[0])][Integer.parseInt(split[1])];
	...
	// this.matrix[Integer.parseInt(splitCell[0])][Integer.parseInt(splitCell[0])] =
	// this.maxTotal
	// - totalValueIniBox;
	// }
	// }
	...
	// return !isInRow(row, number) && !isInCol(col, number) && !isInBox(row, col,
	// number) && checkCageRule(cage);
	// }
	//
	// private boolean isValidCommon(int row, int col, int number) {
	// return !isInRow(row, number) && !isInCol(col, number) && !isInBox(row, col,
